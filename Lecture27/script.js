...
calcAverage("Dolphin Average Score:", 44, 23, 71);
calcAverage("Koalas Average Score:", 65, 54, 49);

function checkWinner() {
  let avgDolphin = calcAverage();
  let avgKoalas = calcAverage();
  if (avgDolphin > avgKoalas * 2) {
    console.log("Dolphin Team is the Winner Team");
