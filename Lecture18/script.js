...
console.log(island, typeof island);
...
console.log("Each Half Population of Country is:", population / 2);
population++;
...
console.log(
  population < 33,
  ",",
  "No, My country population is greater than the average popilation of Yours",
);
let description =
  country +
  " " +
